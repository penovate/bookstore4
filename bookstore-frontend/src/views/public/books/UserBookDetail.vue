            ...
            <v-row>
                ...
                <v-col cols="12" md="4" class="d-flex justify-center align-start">
                    <div class="image-wrapper elevation-3 rounded">
                        <v-img v-if="imageUrl" :src="imageUrl" cover max-width="100%" aspect-ratio="0.7"></v-img>
                        <v-sheet v-else color="grey-lighten-3" class="d-flex align-center justify-center" height="400"
                            width="300">
                ...
                <v-col cols="12" md="8">
                    <div class="d-flex flex-column h-100">
                        ...
                        <div class="text-subtitle-1 mb-4 text-grey-darken-2">
                            ...
                            <div class="mb-1"><strong class="me-2">譯者:</strong> {{ book.translator || '無' }}</div>
                        ...
                        <div class="d-flex gap-3 mt-4">
                            <v-btn variant="outlined" color="primary" size="large" prepend-icon="mdi-heart-outline"
                                @click="addToCollection">
                                收藏
                            </v-btn>
                            <v-btn variant="tonal" color="secondary" size="large" prepend-icon="mdi-cart-plus"
                                class="ms-3" @click="addToCart" :disabled="book.stock <= 0">
                                加入購物車
                            </v-btn>
                            <v-btn variant="flat" color="primary" size="large" class="ms-3 flex-grow-1" @click="buyNow"
