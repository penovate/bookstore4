<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" import="java.util.*, bookstore.bean.Orders"
    %>
    <%!
	...
	<div class="top-action-group">
            ...
            <tbody>
                <% List<Orders> orders = (List<Orders>) request.getAttribute("orders");
                        ...
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-detail" data-id="<%= order.getOrderId() %>">查詢明細</button><br>
							    <button class="btn btn-edit btn-update" data-id="<%= order.getOrderId() %>"
                                    data-recipient="<%= order.getRecipientAt() %>"
                                    data-address="<%= order.getAddress() %>" data-phone="<%= order.getPhone() %>"
                                    data-payment="<%= order.getPaymentMethod() %>"
                                    data-status="<%= order.getOrderStatus() %>"
                                    data-total="<%= order.getTotalAmount() %>">修改訂單</button><br>
                                <button class="btn btn-del btn-delete" data-id="<%= order.getOrderId() %>">取消訂單</button>
                            </td>
                        </tr>
                        <% } } else { %>
                            <tr>
        ...
        <div id="custom-modal" class="modal">
            <div class="modal-content">
                <div id="modal-content-icon" class="modal-icon">
                    </div>
                <p id="modal-content-text" class="modal-text">
                    </p>
        ...
        <script>
            ...
            $(function () {
                ...
                $(".btn-delete").click(function () {
                    ...
                    // 彈窗確認是否取消訂單
                    showConfirmModal('確定要取消這筆訂單嗎？', function(confirmed) {
                        if (confirmed) {
